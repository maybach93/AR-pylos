...
public enum GameStateMachine: Int {
    ...
    case playerTurn //Server sends events to currentPlayer to Action, and other player to wait for currentPlayer
    case waitingForPlayer //Server waits for currentPlayer to send Action. Once server got event, it goes to next state
